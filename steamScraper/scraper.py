...
def get_game_review(id, language='default', pageOffset = 0):
    ...
    Returns:
        ...
        page: the total number of pages of reviews loaded
            """    
    user_name_list = []
    hour_list = []
    user_link_list = []
    ...
    while True:
        if (i % 100 == 0):
            print('Loaded ' + str(i) + "pages of reviews " + "\n") 
        url=f'https://steamcommunity.com/app/{id}/reviews/'
        params = {
            'filterLanguage': language,
            'userreviewsoffset': i  * 100,
            'p': i + 1,
        ...
        if not reviews:
            print("No further reviews found as of page " + str(i)+ ", skipping")
            break   
